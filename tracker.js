(function () {
  ...
  var SCHED = [
    ...
    {u:u(6,28,6,0,M),    lat:46.0038, lng:-112.5348, n:'Depart Butte', d:2},
    {u:u(6,28,8,0,M),    lat:44.6621, lng:-111.1041, n:'West Yellowstone Entrance', d:2},
    {u:u(6,28,8,30,M),   lat:44.7262, lng:-110.7034, n:'Norris Geyser Basin', d:2},
    {u:u(6,28,10,30,M),  lat:44.9686, lng:-110.6853, n:'Mammoth Hot Springs', d:2},
    {u:u(6,28,12,0,M),   lat:45.0327, lng:-110.7039, n:'Lunch at Gardiner', d:2},
    {u:u(6,28,13,30,M),  lat:45.0327, lng:-110.7039, n:'Depart Gardiner', d:2},
    {u:u(6,28,15,0,M),   lat:44.8985, lng:-110.2073, n:'Lamar Valley', d:2},
    {u:u(6,28,17,30,M),  lat:44.8921, lng:-110.3879, n:'Tower Falls', d:2},
    {u:u(6,28,19,30,M),  lat:44.4187, lng:-111.3732, n:'Island Park Cabin', d:2},

    {u:u(6,29,7,0,M),    lat:44.4187, lng:-111.3732, n:'Depart Island Park', d:3},
    {u:u(6,29,7,30,M),   lat:44.6572, lng:-111.0947, n:'West Entrance Gate', d:3},
    {u:u(6,29,8,0,M),    lat:44.5426, lng:-110.8097, n:'Fountain Paint Pots', d:3},
    {u:u(6,29,9,30,M),   lat:44.5249, lng:-110.8383, n:'Grand Prismatic Overlook', d:3},
    {u:u(6,29,11,30,M),  lat:44.4605, lng:-110.8281, n:'Old Faithful', d:3},
    {u:u(6,29,15,0,M),   lat:44.5449, lng:-110.3830, n:'Yellowstone Lake', d:3},
    {u:u(6,29,18,30,M),  lat:44.4187, lng:-111.3732, n:'Return to Island Park', d:3},

    {u:u(6,30,7,0,M),    lat:44.4187, lng:-111.3732, n:'Depart Island Park', d:4},
    {u:u(6,30,7,30,M),   lat:44.7133, lng:-110.7333, n:'Artists Paint Pots', d:4},
    {u:u(6,30,8,30,M),   lat:44.7180, lng:-110.4950, n:'Grand Canyon of Yellowstone', d:4},
    {u:u(6,30,12,0,M),   lat:44.6551, lng:-110.4586, n:'Hayden Valley', d:4},
    {u:u(6,30,12,30,M),  lat:44.6259, lng:-110.4324, n:'Mud Volcano', d:4},
    {u:u(6,30,15,0,M),   lat:44.4159, lng:-110.5728, n:'West Thumb Geyser Basin', d:4},
